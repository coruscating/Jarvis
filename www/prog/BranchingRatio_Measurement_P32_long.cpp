...
int main()
{
    ...
    for( loop=0;loop<branching_ratio_loops;loop++) {      
        ...
        d.Timing.WaitUntilTime(us(31));
        blue408.Enable();

        d.Timing.WaitUntilTime(us(61));
        blue408.Disable();

        d.Timing.WaitUntilTime(us(62));
        ir1033.Set(3);

        d.Timing.WaitUntilTime(us(130));
        ir1033.Set(0);
        ...
        blue422.SetFreq(0);
        d.Timing.WaitUntilTime(us(161));
        blue422.Update();

        blue422.SetFreq(branching_ratio_detuning);
        d.Timing.WaitUntilTime(us(162));
        blue422.Update();

        blue422.SetFreq(0);
        d.Timing.WaitUntilTime(us(192));
        blue422.Update();

        d.Timing.WaitUntilTime(us(193));
        ir1092.Enable();
        d.Timing.WaitUntilTime(us(263));
        ir1092.Disable();
