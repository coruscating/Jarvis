...
#define loops 200
#define runtime us(100)
#define timestep us(1)
#define detuningstep kHz(0)
#define Maxdetune kHz(2000)

#define ramseydelay us(10)
int main()
{
    // Initialize:
    DDScon d;
    ...
    for( detuning = qubit_transition-kHz(200);detuning <= qubit_transition+Maxdetune;detuning=detuning + detuningstep){
        a = 0;
